...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    public void OnPurchaseFailed(Product product, PurchaseFailureReason reason)
    {
        ...
        if (reason == PurchaseFailureReason.DuplicateTransaction)
        {
            ...
            if (String.Equals(product.definition.storeSpecificId, "ad_free_pass", StringComparison.Ordinal))
            {
            ...
            else if (String.Equals(product.definition.storeSpecificId, "fast_package", StringComparison.Ordinal))
            {
            ...
            else if (String.Equals(product.definition.storeSpecificId, "good_package", StringComparison.Ordinal))
            {
            ...
            else if (String.Equals(product.definition.storeSpecificId, "start_package", StringComparison.Ordinal))
            {
