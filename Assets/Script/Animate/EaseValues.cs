...
public class EaseValues : MonoBehaviour
{

    // Visual Graph https://easings.net/ko
    ...
    */
    ...
    public static EaseValues instance;
    ...
    public float GetAnimCurve(AnimCurveType animCurveType, float timeValue)
    {
        switch (animCurveType)
        {
            case AnimCurveType.EaseInQuad: return EaseInQuad(0f, 1f, timeValue);
            case AnimCurveType.EaseOutQuad: return EaseOutQuad(0f, 1f, timeValue);
            case AnimCurveType.EaseInOutQuad: return EaseInOutQuad(0f, 1f, timeValue);
            case AnimCurveType.EaseOutCubic: return EaseOutCubic(0f, 1f, timeValue);
            case AnimCurveType.EaseInOutCubic: return EaseInOutCubic(0f, 1f, timeValue);
            case AnimCurveType.Spring: return Spring(0f, 1f, timeValue);
            case AnimCurveType.EaseInQuint: return EaseInQuint(0f, 1f, timeValue);
            case AnimCurveType.EaseInOutSine: return EaseInOutSine(0f, 1f, timeValue);   
            default: return 0;
        }
    }
