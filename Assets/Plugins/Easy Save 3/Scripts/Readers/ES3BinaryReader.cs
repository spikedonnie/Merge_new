...
namespace ES3Internal
{
    ...
    public class ES3BinaryReader : ES3Reader
    {
        ...
        {
            /* Read the Type byte as we won't need this*/
            baseReader.ReadByte(); return base.StartReadObject();
        }
        ...
        {
            /* Read the Type byte as we won't need this*/
            baseReader.ReadByte(); return true;
        }
        ...
        #endregion Property/Key Methods
        ...
        {
            baseReader.ReadByte(); return baseReader.ReadString();
        }

        internal override char Read_char()
        {
            baseReader.ReadByte(); return baseReader.ReadChar();
        }

        internal override float Read_float()
        {
            baseReader.ReadByte(); return baseReader.ReadSingle();
        }

        internal override int Read_int()
        {
            baseReader.ReadByte(); return Read7BitEncodedInt();
        }

        internal override bool Read_bool()
        {
            baseReader.ReadByte(); return baseReader.ReadBoolean();
        }

        internal override decimal Read_decimal()
        {
            baseReader.ReadByte(); return baseReader.ReadDecimal();
        }

        internal override double Read_double()
        {
            baseReader.ReadByte(); return baseReader.ReadDouble();
        }

        internal override long Read_long()
        {
            baseReader.ReadByte(); return baseReader.ReadInt64();
        }

        internal override ulong Read_ulong()
        {
            baseReader.ReadByte(); return baseReader.ReadUInt64();
        }

        internal override uint Read_uint()
        {
            baseReader.ReadByte(); return baseReader.ReadUInt32();
        }

        internal override byte Read_byte()
        {
            baseReader.ReadByte(); return baseReader.ReadByte();
        }

        internal override sbyte Read_sbyte()
        {
            baseReader.ReadByte(); return baseReader.ReadSByte();
        }

        internal override short Read_short()
        {
            baseReader.ReadByte(); return baseReader.ReadInt16();
        }

        internal override ushort Read_ushort()
        {
            baseReader.ReadByte(); return baseReader.ReadUInt16();
        }

        internal override byte[] Read_byteArray()
        {
            baseReader.ReadByte(); return baseReader.ReadBytes(baseReader.ReadInt32());
        }
        ...
        #endregion Binary-specific methods
